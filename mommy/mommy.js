function myappointmentscheduler() {
    ...
    myappointmentParagraph.innerHTML = `someone booked a spa day for you!`
    myappointmentParagraph.innerHTML = `Hi ${guest}, someone wants to treat you to a spa day for ${appointment} for ${style} we can't wait to see you!`;
